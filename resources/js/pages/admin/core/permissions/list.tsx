        ...
        <AppLayout>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="border-sidebar-border/70 dark:border-sidebar-border relative flex min-h-[100vh] flex-1 flex-col space-y-4 overflow-hidden rounded-xl border md:min-h-min">
                    <DataTableProvider fetchDataUrl={'permissions.data'} columns={columns} formatDataForExport={formatDataForExport}>
                        <DataTableComponent createRouteUrl="permissions.create" />
                    </DataTableProvider>
                </div>
            </div>
        </AppLayout>
